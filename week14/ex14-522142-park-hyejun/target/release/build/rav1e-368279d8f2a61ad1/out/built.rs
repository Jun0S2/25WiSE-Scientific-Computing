...
#[allow(dead_code)]
pub static RUSTC: &str = "/Users/june/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/Users/june/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc";
#[allow(clippy::needless_raw_string_hashes)]
...
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/Users/june/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.90.0 (1159e78c4 2025-09-14)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/Users/june/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V`; empty string if `/Users/june/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
